...
exports.jsdom = function jsdom ( conf ) {
...
exports.runGenerator = function runGenerator ( gen ) {
...
exports.loadByPath = function loadByPath ( options = {} ) {
  let {
    hostname,
    path,
    method='GET',
...
exports.slaceArray = function slaceArray ( arr, countStream ) {
  arr = [].concat(arr);
  let res = [];
